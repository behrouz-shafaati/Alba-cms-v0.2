...
import createObjectIfValueExists from '@/lib/utils/createObjectIfValueExists'
import { Category } from '../category/interface'
import { Post } from './interface'
import { FileDetails } from '@/lib/features/file/interface'
import getTranslation from '@/lib/utils/getTranslation'

export const postUrl = 'api/dashboard/products'
...
export function generatePostSchema({
  ...
  const schemaData = {
    ...
    ...createObjectIfValueExists('headline', translation?.title),
    ...createObjectIfValueExists('description', translation?.excerpt),
    ...
    ...createObjectIfValueExists('image', post?.image?.src),
