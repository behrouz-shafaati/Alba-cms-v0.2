...
import shippingAddressCtrl from '@/lib/features/shippingAddress/controller'
import revalidatePathCtrl from '@/lib/revalidatePathCtrl'
import { revalidatePath } from 'next/cache'
import { getSettings } from '../settings/controller'
import { Settings } from '../settings/interface'
import verificationCtrl from '@/lib/features/verification/controller'
...
export async function loginAction(
  ...
  const userSessionData = {
    ...
    name: user.name,
    roles: user.roles,
    image: { srcSmall: user?.image?.srcSmall ?? '' },
    locale: user?.metadata?.locale || null,
  }
