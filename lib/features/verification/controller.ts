...
import { generateMailTemplate } from '@/lib/email/generateMailTemplate'
import toMinutes from '@/lib/utils/toMinutes'
import getTranslation from '@/lib/utils/getTranslation'
import { sendMobileVerifySms } from '@/lib/sms/sendMobileVerifySms'
...
class controller extends baseController {
  ...
  async updateVerificationEmail({
    ...
    try {
      await sendEmail(
        ...
        generateMailTemplate(siteInfo?.site_title, plainCode, 'fa')
      )
      return {
  ...
  async updateVerificationMobile({
    ...
    try {
      await sendMobileVerifySms(mobile, plainCode)
      return {
  ...
  async sendMobileVerificationCode({
    ...
    try {
      console.log('$------------------ plainCode:', plainCode)
      const resultSendSMS = await sendMobileVerifySms(user?.mobile, plainCode)
