...
export default function ClientCampaignTable({
  locale,
  findResult,
  GroupAction,
  canCreate,
  ...
  return (
    <>
      <div className="flex items-start justify-between">
        <Heading
          title={`${dictionary.feature.adCampaign.title} (${findResult?.totalDocuments || 0})`}
          description={dictionary.feature.adCampaign.description}
        />
        {canCreate && (
          <LinkButton
          ...
          >
            ...
            {dictionary.feature.adCampaign.create}
          </LinkButton>
        )}
      </div>
      <DataTable
