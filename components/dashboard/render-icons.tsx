...
export default function renderIcon(icon: string | undefined) {
  switch (icon) {
    ...
    case 'Menu':
      return <Menu className="mr-2 h-4 w-4" />
    case 'ClipboardList':
    ...
    case 'SlidersVertical':
      return <SlidersVertical className="mr-2 h-4 w-4" />
    case 'StickyNote':
      return <StickyNote className="mr-2 h-4 w-4" />
    case 'Megaphone':
      return <Megaphone className="mr-2 h-4 w-4" />
    case 'LogOut':
      return <LogOut className="mr-2 h-4 w-4" />
    case 'Files':
      return <Files className="mr-2 h-4 w-4" />
    case 'Plus':
